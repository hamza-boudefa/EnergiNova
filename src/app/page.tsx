      ...
      <div className="container max-w-8xl mx-auto px-5 2xl:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-semibold text-dark dark:text-white mb-4">Expertise reconnue</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-2xl font-semibold text-dark dark:text-white mb-4">Innovation constante</h3>
            <p className="text-dark/70 dark:text-white/70 leading-relaxed">
