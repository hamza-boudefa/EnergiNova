          ...
          <div className="grid grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-6 col-span-12">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-dark/70 dark:text-white/70">Projets réalisés</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-primary mb-2">5+</div>
                  <div className="text-dark/70 dark:text-white/70">Années d'expérience</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-primary mb-2">100%</div>
                  <div className="text-dark/70 dark:text-white/70">Satisfaction client</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-primary mb-2">24/7</div>
                  <div className="text-dark/70 dark:text-white/70">Support technique</div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 col-span-12">
              <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-8">
                <h3 className="text-2xl font-semibold text-dark dark:text-white mb-6">Notre expertise</h3>
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-dark dark:text-white">Énergies Renouvelables</h4>
                      <p className="text-sm text-dark/70 dark:text-white/70">Solaire, éolien, hydraulique</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-dark dark:text-white">BIM Management</h4>
                      <p className="text-sm text-dark/70 dark:text-white/70">Modélisation et coordination</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-dark dark:text-white">Diagnostics Énergétiques</h4>
                      <p className="text-sm text-dark/70 dark:text-white/70">Performance et optimisation</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-dark dark:text-white">Traitement des Eaux</h4>
                      <p className="text-sm text-dark/70 dark:text-white/70">Potable et eaux usées</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container max-w-8xl mx-auto px-5 2xl:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-dark dark:text-white mb-4">Innovation</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-dark dark:text-white mb-4">Transition Énergétique</h3>
              <p className="text-dark/70 dark:text-white/70 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-dark dark:text-white mb-4">Accompagnement Personnalisé</h3>
              <p className="text-dark/70 dark:text-white/70 leading-relaxed">
        ...
        <div className="container max-w-8xl mx-auto px-5 2xl:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-dark dark:text-white mb-2">Directeur Technique</h3>
              <p className="text-primary font-medium mb-3">Ingénieur Énergies Renouvelables</p>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-dark dark:text-white mb-2">Responsable BIM</h3>
              <p className="text-primary font-medium mb-3">Expert BIM & Modélisation</p>
              <p className="text-dark/70 dark:text-white/70 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-dark dark:text-white mb-2">Ingénieur Diagnostics</h3>
              <p className="text-primary font-medium mb-3">Expert Performance Énergétique</p>
              <p className="text-dark/70 dark:text-white/70 text-sm">
